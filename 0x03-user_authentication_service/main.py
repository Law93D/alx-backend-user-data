#!/usr/bin/env python3
"""
Main module for testing the authentication service.
"""
import requests
...
def log_out(session_id: str) -> None:
    """Log out and ensure session ID is invalidated."""
...
def reset_password_token(email: str) -> str:
    ...
    assert response.status_code == 200, "Failed to request reset token"
